...
UNK_TOKEN = config.UNK_TOKEN # This has a vocab id, which is used to represent out-of-vocabulary words
START_TOKEN = config.START_TOKEN # This has a vocab id, which is used at the start of every decoder input sequence
END_TOKEN = config.END_TOKEN # This has a vocab id, which is used at the end of untruncated target sequences
...
def example_generator(qa_path, single_pass):
...
def show_art_oovs(article, vocab):
  ...
  unk_token = vocab.word2id(UNK_TOKEN)
  words = article.split(' ')
